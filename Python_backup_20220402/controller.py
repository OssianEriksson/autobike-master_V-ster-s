...
class Controller(object):
    ...
    def log_headerline(self):
        ...
        if gps_use:
            self.log_header_str += ['v_estimated', 'yaw_estimated', 'heading_estimated', 'x_estimated', 'y_estimated', 'GPS_timestamp', 'x_GPS', 'y_GPS', 'theta_GPS', 'theta_GPS_noUnwrap', 'latitude', 'longitude', 'lat_estimated', 'lon_estimated', 'v_gps', 'course_gps','status','NMEA timestamp']
        if laserRanger_use:
