...
initial_speed = 3.2                              # [m/s] Forward speed of the bike
...
# rollref_file = 'roll_ref_0.csv'
# rollref_file = 'roll_ref_l3deg.csv'
#rollref_file = 'roll_ref_l5deg.csv'
#rollref_file = 'roll_ref_l10deg.csv'
#rollref_file = 'roll_ref_r3deg.csv'  # Direction inversed, so leaning to left!
#rollref_file = 'roll_ref_r5deg.csv'
#rollref_file = 'roll_ref_r10deg.csv'
# rollref_file = 'roll_ref_StepT5_3deg.csv'
#rollref_file = 'roll_ref_StepT5_5deg.csv'
#rollref_file = 'roll_ref_StepT5_-3deg.csv'
#rollref_file = 'roll_ref_StepT5_-5deg.csv'
# rollref_file = 'roll_UrefBandStop23_MagPM10LP5.csv'
#rollref_file = 'roll_UrefBandStop23_MagPM14LP5.csv'
#rollref_file = 'roll_UrefBandStop23_MagPM5LP4.csv'

####################################################################################################################
####################################################################################################################
# Steering disturbance file
strdistbref_file = 'nofile'
# strdistbref_file = 'str_Udistb_bandstop23_5degLP3.csv'
#strdistbref_file = 'str_Udistb_bandstop23_9degLP5.csv'
#strdistbref_file = 'str_Udistb_bandstop23_4degLP5.csv'
